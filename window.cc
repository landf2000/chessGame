...
void Xwindow::drawLines(XPoint *points, int numPoints, int colour) {

	XSetForeground(d, gc, colours[colour]);
	XDrawLines(d, w, gc, points, numPoints,  CoordModeOrigin);
	XSetForeground(d, gc, colours[Black]);

}

void Xwindow::fillPolygon(XPoint* points, int numPoints,int shape,int colour){

  XSetForeground(d, gc, colours[colour]);
  XFillPolygon(d, w, gc, points, numPoints, shape, CoordModeOrigin);
  XSetForeground(d, gc, colours[Black]);
